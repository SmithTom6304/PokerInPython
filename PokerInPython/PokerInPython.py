...
def main():
	...
	Card1 = UserInterface.Card(3, 'S', (width/2) - 20, height - 80)
	...
	while True:
		...
		Card1.rect.x = card1pos[0]
		Card1.rect.y = card1pos[1]
		...
		if (Card1.rect.collidepoint(mousepos) and not card2rect.collidepoint(mousepos)):
			Card1.rect.y -= 10
